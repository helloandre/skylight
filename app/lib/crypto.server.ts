...
const DEFAULT_PARAMS = { name: "PBKDF2", hash: "SHA-256" };

// https://gist.githubusercontent.com/chrisveness/770ee96945ec12ac84f134bf538d89fb/raw/5ecf03a28a532f9df3629291eb9333fc149735e7/crypto-pbkdf2.js
/**
 ...
 *
 * @example
 *   const key = await hash('pāşšŵōřđ'); // eg 'djAxBRKXWNWPyXgpKWHld8SWJA9CQFmLyMbNet7Rle5RLKJAkBCllLfM6tPFa7bAis0lSTiB'
 */
export async function hash(password: string, iterations = ITERATIONS) {
  ...
  const params = { ...DEFAULT_PARAMS, salt: saltUint8, iterations }; // pbkdf2 params
  ...
  const compositeBase64 = btoa(VERSION + compositeStr); // encode as base64
